...
{
    public static Dictionary<int, ActionHandler> systemActionHandlers = new();

    public static Dictionary<int, ConditionHandler> systemConditionHandlers = new()
    {
    ...
    public static void CompareGlobalString(Condition condition, ObjectInfo obj, List<Parameter> parameters)
    {
        ...
        FTEventViewer.WriteLine(
            $"GlobalValue{Convert.ToChar(param0.Value + 65).ToString().ToUpper()} {param1.GetOperator()} {ExpressionConverter.ConvertExpression(param1)}");
    }
    ...
    public static void Compare(Condition condition, ObjectInfo obj, List<Parameter> parameters)
    {
        ...
        var param1 = parameters[1].Loader as ExpressionParameter;
        FTEventViewer.WriteLine(
            $"{ExpressionConverter.ConvertExpression(param0)} {param0.GetOperator()} {ExpressionConverter.ConvertExpression(param1)}");
    }
